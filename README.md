...
## WHY ?
  If you want to crack the interviews and get into the product based componies requirments.
  
  If you love to solve the real-world complex problems then you implement DSA.
